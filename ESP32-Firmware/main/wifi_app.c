...
@param event_vase the base id of the event to register the handler for
...
static void wifi_app_soft_ap_config(void) {
    ...
    wifi_config_t ap_config = {
        .ap = {
            ...
            .beacon_interval = WIFI_AP_BEACON_INTERVALS},
    };
    ...
    inet_pton(AF_INET, WIFI_AP_GATEWAY, &ap_ip_info.gw);       //> Assign access point's static IP, GW, and netmask
    inet_pton(AF_INET, WIFI_AP_NETMASK, &ap_ip_info.netmask);  //> Assign access point's static IP, GW, and netmask
    ...
    ESP_ERROR_CHECK(esp_wifi_set_mode(WIFI_MODE_APSTA));                     //> Setting the mode as AP / Station Mode
