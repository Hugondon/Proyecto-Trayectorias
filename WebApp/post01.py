...
def send_data():
    ...
    joint_angle_velocity_base_mrad_s = request.json["Joint_Angle_Velocity"][0][
        "Base_mrad_s"
    ]
    joint_angle_velocity_shoulder_mrad_s = request.json["Joint_Angle_Velocity"][1][
        "Shoulder_mrad_s"
    ]
    joint_angle_velocity_elbow_elbow_mrad_s = request.json["Joint_Angle_Velocity"][2][
        "Elbow_mrad_s"
    ]
    joint_angle_velocity_wrist_1_mrad_s = request.json["Joint_Angle_Velocity"][3][
        "Wrist1_mrad_s"
    ]
    joint_angle_velocity_wrist_2_mrad_s = request.json["Joint_Angle_Velocity"][4][
        "Wrist2_mrad_s"
    ]
    joint_angle_velocity_wrist_3_mrad_s = request.json["Joint_Angle_Velocity"][5][
        "Wrist3_mrad_s"
    ]

    tcp_position_orientation_x = request.json["TCP_Position_Orientation"][0][
        "X_tenth_mm"
    ]
    tcp_position_orientation_y = request.json["TCP_Position_Orientation"][1][
        "Y_tenth_mm"
    ]
    tcp_position_orientation_z = request.json["TCP_Position_Orientation"][2][
        "Z_tenth_mm"
    ]
